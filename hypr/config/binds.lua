...
hl.bind(mainMod .. " + CONTROL + 1", hl.dsp.window.move({ monitor = MONITOR1 }))
hl.bind(mainMod .. " + CONTROL + 2", hl.dsp.window.move({ monitor = MONITOR2 }))
hl.bind(mainMod .. " + CONTROL + 3", hl.dsp.window.move({ monitor = MONITOR3 }))
...
hl.bind(mainMod .. " + U", hl.dsp.exec_cmd(noctCall .. "session lock"))
